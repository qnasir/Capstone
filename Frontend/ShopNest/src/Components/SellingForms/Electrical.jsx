...
function Electrical() {
    ...
    const onSubmit = async (data) => {
        if (!data.name || !data.title || !data.brand || !data.warranty || !data.condition || !data.price || !data.location || !data.description) {
            ...
            <div className='main'>
                <div className="add-product-container">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} >
                        ...
                        <br />
                            <button className='btn' type="submit">Upload Images</button>
                    </form>
                </div>
            </div>
        </>
